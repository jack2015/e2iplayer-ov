...
# LOCAL import
###################################################
from Plugins.Extensions.IPTVPlayer.tools.iptvtools import printDBG, iptv_system, eConnectCallback, E2PrioFix
        ...
        if 0:
            ...
            for item in tmpTab:
                ...
                if 'flashVer' == argName:
                    ...
                    continue
                rtmpdump_url += ' --' + item
        cmd = DMHelper.GET_RTMPDUMP_PATH() + " " + rtmpdump_url + ' --realtime -o "' + self.filePath + '" '
