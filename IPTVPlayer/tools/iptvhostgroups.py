...
class IPTVHostsGroups:
    def __init__(self):
        ...
        self.PREDEFINED_HOSTS['moviesandseries'] = ['appletrailers', 'efilmytv', 'alltubetv', 'ekinomaniak', 'ekinotv', 'cdapl', 'cdafilmy', 'iitvpl', 'filman', 'ogladajto', 'govodtv', 'filmynadzis', 'freediscpl',
        ...
        self.PREDEFINED_HOSTS['polish'] = ['youtube', 'webstream', 'efilmytv', 'alltubetv', 'ekinomaniak', 'ekinotv', 'cdapl', 'cdafilmy', 'iitvpl', 'filman', 'ogladajto', 'govodtv', 'filmynadzis', 'tvpvod', 'ipla', 'tvnvod', 'vodpl',
