...
class IPTVHostsGroups:
    def __init__(self):
        ...
        self.PREDEFINED_HOSTS['polish'] = ['youtube', 'webstream', 'efilmytv', 'alltubetv', 'ekinomaniak', 'ekinotv', 'cdapl', 'vizjerpl', 'iitvpl', 'filman', 'ogladajto', 'govodtv', 'filmynadzis', 'tvpvod', 'ipla', 'vodpl',
