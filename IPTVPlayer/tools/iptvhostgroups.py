...
class IPTVHostsGroups:
    def __init__(self):
        ...
        self.PREDEFINED_HOSTS['moviesandseries'] = ['appletrailers', 'efilmytv', 'ekinotv', 'cdapl', 'vizjerpl', 'zaluknijcc', 'iitvpl', 'filman', 'ogladajto', 'govodtv', 'filmynadzis', 'freediscpl',
        ...
        self.PREDEFINED_HOSTS['polish'] = ['youtube', 'webstream', 'efilmytv', 'ekinotv', 'cdapl', 'vizjerpl', 'zaluknijcc', 'iitvpl', 'filman', 'ogladajto', 'govodtv', 'filmynadzis', 'tvpvod', 'ipla', 'vodpl',
